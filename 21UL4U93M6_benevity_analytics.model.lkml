...
explore: fact_transaction {
  ...
  join: 21UL4U93M6_vw_dim_user_profile_field {
    type: left_outer
    sql_on:  ${vw_fact_transaction_entry.user_profile_field_key} = ${21UL4U93M6_vw_dim_user_profile_field.user_profile_field_key}  ;;
...
explore: vw_realtimereporting {
  ...
  label: "coolCompany-21UL4U93M6 Real-Time Reporting"
}
