...
explore: fact_transaction {
  ...
  join: 1Z8JPYLU88_vw_dim_user_profile_field {
    type: left_outer
    sql_on:  ${vw_fact_transaction_entry.user_profile_field_key} = ${1Z8JPYLU88_vw_dim_user_profile_field.user_profile_field_key}  ;;
    relationship: many_to_one
    #fields: []
  }
...
explore: vw_realtimereporting {
  ...
  label: "coolCompany-1Z8JPYLU88 Real-Time Reporting"
}
