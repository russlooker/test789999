...
explore: fact_transaction {
  ...
  join: 1SR6C1AVDJ_vw_dim_user_profile_field {
    type: left_outer
    sql_on:  ${vw_fact_transaction_entry.user_profile_field_key} = ${1SR6C1AVDJ_vw_dim_user_profile_field.user_profile_field_key}  ;;
...
explore: vw_realtimereporting {
  ...
  label: "coolCompany-1SR6C1AVDJ Real-Time Reporting"
}
