view: 1PMN96TBLL_vw_dim_user_profile_field_base {
sql_table_name: [RPT].[vwDimUserProfileField_1PMN96TBLL] ;;
label: "coolCompany-1PMN96TBLLCustom Fields"
...
dimension: profile_lastdateworked {
